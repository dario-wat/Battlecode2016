...
public class RobotPlayer {
  ...
  private static int currentNeutral = -1;
...
//              int byc = Clock.getBytecodeNum(); 
              List<RobotInfo> robots = Sensing.senseNearbyNeutral(rc);
              ...
              if (nearestNeutral != null) {
                ...
                MapLocation maxParts = Sensing.findMaxParts(rc, parts);
                if (maxParts != null) {
...
//              currentNeutral = nearestNeutral.ID;
              
//              System.out.println(Clock.getBytecodeNum()-byc);
